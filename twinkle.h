#include "ESP32_Spectrum_Analyzer_IoT.h"
...
//CRGBSet leds2(realleds, NUM_LEDS);
...
void choosePalette( CRGBPalette16& pal)
{ 
  pal = *(ActivePaletteList[buttonPushCounter-8]);
}

void twinkleLEDS(){
  if((buttonPushCounter-8)==10){
